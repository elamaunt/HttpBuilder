...
namespace HttpBuilder
{
    public static class MimeTypeMap
    {
        ...
        public static bool IsImageExtension(string extension)
        {
            ...
            ext = ext.ToLower();
            var supported = ext == "tiff" || ext == "tif" ||
               ext == "jpeg" || ext == "jpg" ||
               ext == "gif" ||
               ext == "png" ||
               ext == "dib" ||
        ...
        public static bool IsVideoExtension(string extension)
        {
            ...
            return mimeType.StartsWith("video", StringComparison.Ordinal);
        }

        public static bool IsPdfExtension(string extension)
        {
            var mimeType = GetMimeType(extension);
            return mimeType.EndsWith("pdf", StringComparison.Ordinal);
        }

        public static bool IsIOSSupportedExtension(string extension)
        {
